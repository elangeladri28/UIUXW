    ...
    <div class="container" style="margin-top: 50px;">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <div class="card mt-4">
                    <img src="https://res.cloudinary.com/rsc/image/upload/b_rgb:FFFFFF,c_pad,dpr_1.0,f_auto,q_auto,w_700/c_pad,w_700/Y2009216-01.jpg"
                        class="card-img-top">
                    <div class="card-body">
                        ...
                        <!-- <h2 class="udlite-heading-xl styles--audience__title--1Sob_">¿Para quién es este curso?</h2>
                        <ul class="styles--audience__list--3NCqY">
                            <li>Cualquier persona que quiera aprender JavaScript, el lenguaje más popular en los últimos años
                            </li>
                            <li>Si buscas un curso de JavaScript sin Frameworks ni jQuery, este curso es el indicado
                            </li>
                            <li>Si quieres aprender las últimas adiciones de ECMAScript estas en el curso adecuado</li>
                            <li>Si eres nuevo programando, hay un capitulo de Fundamentos donde aprenderás lo básico del lenguaje
                            </li>
                                ...
                                <h5 class="card-text">Puedes retirar también en sucursales de correo u otros puntos.<h5>
                                        ...
                                        <h5 class="card-text">Stock disponible.<h5>
                                                ...
                                                <a href="#" class="btn btn-success"
                                                    style="padding-left:30px; padding-right:30px;">Comprar Ahora</a>
                                                <br>
                                                <br>
                                                <a href="#" class="btn btn-primary"
                                                    style="padding-left:20px; padding-right:20px;">Agregar al
                                                    Carrito</a>
                                                <br>
                                                <br>
                                                <h5 class="card-text">Medios de Pago<h5>
                                                        ...
                                                        <h6 class="card-text">Tarjetas de Credito y Debito<h6>
                                                                ...
                                                                <h6 class="card-text">PayPal<h6>
                                                                        ...
                                                                        <img src="http://sistema.inmosuite.mx/images/pago-en-efectivo.png"
                                                                            alt="" width="95px">
