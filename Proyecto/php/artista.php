            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    result.forEach(categoria => {
                        console.log(categoria.Product_Name);
                        ...
                        <div class="col mb-5">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">${categoria.Product_Name}</h5>
                                    <!-- Product price-->
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="seleccionado.php">Mirar</a>
                                </div>
                            </div>
                        </div>
                        </div>
